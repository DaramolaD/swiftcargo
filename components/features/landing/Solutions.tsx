  ...
  return (
    <section className="container mx-auto py-20 flex flex-col gap-10 items-center px-5 md:px-6">
      <div className="flex flex-col items-center gap-4 md:gap-5">
        ...
        <p className="text-Dark_Paragraph text-lg md:text-xl text-center max-w-[1120px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {logisticsServices.map((service) => (
          <div
            key={service.id}
            className={`flex flex-col gap-10 p-10 rounded-2xl ${service.bg}`}
          >
            <Image
              src={service.icon}
              alt={service.title}
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <p className={`font-normal text-base md:text-lg text-Dark_Paragraph ${service.pText}`}>
                {service.description}
              </p>
            </div>
          </div>
